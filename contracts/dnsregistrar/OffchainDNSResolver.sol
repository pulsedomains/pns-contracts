...
contract OffchainDNSResolver is IExtendedResolver {
    ...
    constructor(PNS _pns, DNSSEC _oracle, string memory _gatewayURL) {
        pns = _pns;
        oracle = _oracle;
    ...
    function resolveCallback(
        ...
        for (
            ...
            // Look for a valid PNS-DNS TXT record
    ...
    function parseRR(
        ...
        if (txt.length < 5 || !txt.equals(0, "PNS1 ", 0, 5)) {
            return (address(0), "");
        }
    ...
    function resolveName(
        ...
        address resolver = pns.resolver(node);
